...
import { X, Heart, AlertTriangle, Shield, Home, Activity, Utensils, Stethoscope, Clock } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { HealthAdviceResponse } from '@/services/healthadvice';
...
const HealthAdviceModal = ({ isOpen, onClose, advice, isLoading }: HealthAdviceModalProps) => {
      ...
      <div className="bg-slate-800 rounded-2xl p-6 m-4 max-w-4xl max-h-[90vh] overflow-y-auto border border-slate-700 shadow-2xl">
        ...
        {isLoading ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-300">Generating personalized health advice...</p>
          </div>
        ) : advice ? (
          <div className="space-y-6">
            ...
            <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-600">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  AQI {advice.air_quality_summary.primary_aqi} - {advice.air_quality_summary.category}
                </div>
                <span className="text-gray-300">Primary Pollutant: {advice.air_quality_summary.pollutant}</span>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-900/30 to-orange-900/30 rounded-xl p-4 border border-red-700/50">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2 text-red-300">Overall Assessment</h3>
            ...
            <div className="bg-gradient-to-br from-yellow-900/30 to-orange-900/30 rounded-xl p-4 border border-yellow-700/50">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2 text-yellow-300">Immediate Actions</h3>
                  <p className="text-gray-200 leading-relaxed whitespace-pre-line">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-600">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2 text-blue-300">Outdoor Activities</h4>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-600">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2 text-green-300">Protection Measures</h4>
                    <p className="text-gray-300 text-sm leading-relaxed whitespace-pre-line">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-600">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2 text-purple-300">Indoor Recommendations</h4>
                    <p className="text-gray-300 text-sm leading-relaxed whitespace-pre-line">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4 border border-slate-600">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2 text-orange-300">Recovery Advice</h4>
                    <p className="text-gray-300 text-sm leading-relaxed whitespace-pre-line">
            ...
            <div className="bg-gradient-to-br from-red-900/20 to-pink-900/20 rounded-xl p-4 border border-red-600/50">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2 text-red-300">Medical Guidance</h3>
                  <p className="text-gray-200 leading-relaxed whitespace-pre-line">
            ...
            <div className="bg-slate-900/30 rounded-lg p-3 border border-slate-700">
              <div className="flex items-center justify-between text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span>Generated: {new Date(advice.timestamp).toLocaleString()}</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="text-center py-8">
            <p className="text-gray-300">Failed to load health advice. Please try again.</p>
          </div>
        )}
      </div>
    </div>
